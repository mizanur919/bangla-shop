        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-8">
          ...
          <div>
            ...
            <div className="price mt-8 flex flex-row items-center gap-6">
              <h3 className="text-gray-one text-4xl font-semibold">$59.00</h3>
              <p className="line-through font-normal text-3xl text-gray-three">
                $65.00
              </p>
            ...
            <div className="product-count flex flex-row items-center gap-10">
              <div>
              ...
              <div className="flex flex-row items-center gap-5">
                <button className="text-2xl font-thin w-14 h-14 border-2 border border-gray-six rounded-full hover:bg-gray-seven hover:transition-all">
                  -
                </button>
